...
func main() {
	...
	display.Info("Expected: 1 (only system message, no user/assistant/tool messages)")
	...
	display.Info("User, assistant, and tool messages should NOT be added to history.")

...
- **Environment variable control**: Set `NOVA_LOG_LEVEL` to control logging globally
...
Set the `NOVA_LOG_LEVEL` environment variable:
...
func main() {
    // Logger will use NOVA_LOG_LEVEL environment variable
    log := logger.GetLoggerFromEnv()
